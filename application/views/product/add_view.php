      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start --> 
            <form method="post" role="form" action="<?php echo base_url('product/add_submit') ?>" id="product-form" enctype="multipart/form-data">
