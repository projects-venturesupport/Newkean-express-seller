...
{
	define('ADMIN_URL', 'http://localhost/goezzy/admin/');
	define('SITE_TITLE', 'Go Ezzy');
	define('ASSETS_URL', 'http://localhost/goezzy/seller/assets/');
	define('FILE_UPLOAD_BASE_PATH', 'C:/xampp/htdocs/goezzy/web/');
	define('FRONT_URL', 'http://localhost/goezzy/web/');
	$config['base_url'] = 'http://localhost/goezzy/seller/';
